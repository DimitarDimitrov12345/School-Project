import {
    football_game
} from "./../football/2.0.3/library/game.js";
import {
    football_games
} from "./../football/2.0.3/library/games.js";
import {
    football_standings
} from "./../football/2.0.3/library/standings.js";
import {
    baseball_game
} from "./../baseball/2.0.3/library/game.js";
import {
    baseball_games
} from "./../baseball/2.0.3/library/games.js";
import {
    baseball_standings
} from "./../baseball/2.0.3/library/standings.js";
import {
    basketball_game
} from "./../basketball/2.0.3/library/game.js";
import {
    basketball_games
} from "./../basketball/2.0.3/library/games.js";
import {
    basketball_standings
} from "./../basketball/2.0.3/library/standings.js";
import {
    handball_game
} from "./../handball/2.0.3/library/game.js";
import {
    handball_games
} from "./../handball/2.0.3/library/games.js";
import {
    handball_standings
} from "./../handball/2.0.3/library/standings.js";
import {
    hockey_game
} from "./../hockey/2.0.3/library/game.js";
import {
    hockey_games
} from "./../hockey/2.0.3/library/games.js";
import {
    hockey_standings
} from "./../hockey/2.0.3/library/standings.js";
import {
    rugby_game
} from "./../rugby/2.0.3/library/game.js";
import {
    rugby_games
} from "./../rugby/2.0.3/library/games.js";
import {
    rugby_standings
} from "./../rugby/2.0.3/library/standings.js";
import {
    volleyball_game
} from "./../volleyball/2.0.3/library/game.js";
import {
    volleyball_games
} from "./../volleyball/2.0.3/library/games.js";
import {
    volleyball_standings
} from "./../volleyball/2.0.3/library/standings.js";
window.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.getElementById("wg-api-football-games")) {
        ...
        "false" === o && (H = `\n                <div id="wg-${t}-data" class="wg_loader"></div>\n            `), e.innerHTML = H, football_games(r, n, g, s, d, i, b, c, u), $ >= 15 && Number.isInteger($) && (a = setInterval(function() {
    ...
    if (document.getElementById("wg-api-football-game")) {
        ...
        w(l), football_game(r, s, d, n, g, !1), o >= 15 && Number.isInteger(o) && (t = setInterval(function() {
    ...
    if (document.getElementById("wg-api-baseball-games")) {
        ...
        let h = m(7, "-"),
            ...
            T = m(7, "+"),
            H = `\n            <div id="wg-${t}-toolbar" class="wg_toolbar">\n                <span class="wg_button_toggle wg_active" data-select="all" data-sport="${t}">ALL</span>\n                <span class="wg_button_toggle" data-select="live" data-sport="${t}">LIVE</span>\n                <span class="wg_button_toggle" data-select="finished" data-sport="${t}">FINISHED</span>\n                <span class="wg_button_toggle" data-select="scheduled" data-sport="${t}">SCHEDULED</span>\n                <span class="wg-dropdown">\n                    <span class="wg-dropbtn" id="wg-${t}-dropbtn">${E}</span>\n                    <div class="wg-dropdown-content">\n                        <a href="#" data-date="${h}" class="wg-date" data-sport="${t}">${h}</a>\n                        <a href="#" data-date="${f}" class="wg-date" data-sport="${t}">${f}</a>\n                        <a href="#" data-date="${_}" class="wg-date" data-sport="${t}">${_}</a>\n                        <a href="#" data-date="${A}" class="wg-date" data-sport="${t}">${A}</a>\n                        <a href="#" data-date="${v}" class="wg-date" data-sport="${t}">${v}</a>\n                        <a href="#" data-date="${y}" class="wg-date" data-sport="${t}">${y}</a>\n                        <a href="#" data-date="${I}" class="wg-date" data-sport="${t}">${I}</a>\n                        <a href="#" data-date="${E}" class="wg-date wg-dropdown-color-select" data-sport="${t}">TODAY</a>\n                        <a href="#" data-date="${L}" class="wg-date" data-sport="${t}">${L}</a>\n                        <a href="#" data-date="${k}" class="wg-date" data-sport="${t}">${k}</a>\n                        <a href="#" data-date="${B}" class="wg-date" data-sport="${t}">${B}</a>\n                        <a href="#" data-date="${S}" class="wg-date" data-sport="${t}">${S}</a>\n                        <a href="#" data-date="${N}" class="wg-date" data-sport="${t}">${N}</a>\n                        <a href="#" data-date="${D}" class="wg-date" data-sport="${t}">${D}</a>\n                        <a href="#" data-date="${T}" class="wg-date" data-sport="${t}">${T}</a>\n                    </div>\n                </span>\n            </div>\n            <div id="wg-${t}-data" class="wg_loader"></div>\n        `;
        "false" === o && (H = `\n                <div id="wg-${t}-data" class="wg_loader"></div>\n            `), a.innerHTML = H, baseball_games(r, n, g, e, d, i, b, c, u), $ >= 15 && Number.isInteger($) && (s = setInterval(function() {
    ...
    if (document.getElementById("wg-api-basketball-games")) {
        ...
        let h = m(7, "-"),
            ...
            T = m(7, "+"),
            H = `\n            <div id="wg-${t}-toolbar" class="wg_toolbar">\n                <span class="wg_button_toggle wg_active" data-select="all" data-sport="${t}">ALL</span>\n                <span class="wg_button_toggle" data-select="live" data-sport="${t}">LIVE</span>\n                <span class="wg_button_toggle" data-select="finished" data-sport="${t}">FINISHED</span>\n                <span class="wg_button_toggle" data-select="scheduled" data-sport="${t}">SCHEDULED</span>\n                <span class="wg-dropdown">\n                    <span class="wg-dropbtn" id="wg-${t}-dropbtn">${E}</span>\n                    <div class="wg-dropdown-content">\n                        <a href="#" data-date="${h}" class="wg-date" data-sport="${t}">${h}</a>\n                        <a href="#" data-date="${f}" class="wg-date" data-sport="${t}">${f}</a>\n                        <a href="#" data-date="${_}" class="wg-date" data-sport="${t}">${_}</a>\n                        <a href="#" data-date="${A}" class="wg-date" data-sport="${t}">${A}</a>\n                        <a href="#" data-date="${v}" class="wg-date" data-sport="${t}">${v}</a>\n                        <a href="#" data-date="${y}" class="wg-date" data-sport="${t}">${y}</a>\n                        <a href="#" data-date="${I}" class="wg-date" data-sport="${t}">${I}</a>\n                        <a href="#" data-date="${E}" class="wg-date wg-dropdown-color-select" data-sport="${t}">TODAY</a>\n                        <a href="#" data-date="${L}" class="wg-date" data-sport="${t}">${L}</a>\n                        <a href="#" data-date="${k}" class="wg-date" data-sport="${t}">${k}</a>\n                        <a href="#" data-date="${B}" class="wg-date" data-sport="${t}">${B}</a>\n                        <a href="#" data-date="${S}" class="wg-date" data-sport="${t}">${S}</a>\n                        <a href="#" data-date="${N}" class="wg-date" data-sport="${t}">${N}</a>\n                        <a href="#" data-date="${D}" class="wg-date" data-sport="${t}">${D}</a>\n                        <a href="#" data-date="${T}" class="wg-date" data-sport="${t}">${T}</a>\n                    </div>\n                </span>\n            </div>\n            <div id="wg-${t}-data" class="wg_loader"></div>\n        `;
        "false" === o && (H = `\n                <div id="wg-${t}-data" class="wg_loader"></div>\n            `), a.innerHTML = H, basketball_games(r, n, g, e, s, i, b, c, u), $ >= 15 && Number.isInteger($) && (l = setInterval(function() {
    ...
    if (document.getElementById("wg-api-handball-games")) {
        ...
        let h = m(7, "-"),
            ...
            T = m(7, "+"),
            H = `\n            <div id="wg-${t}-toolbar" class="wg_toolbar">\n                <span class="wg_button_toggle wg_active" data-select="all" data-sport="${t}">ALL</span>\n                <span class="wg_button_toggle" data-select="live" data-sport="${t}">LIVE</span>\n                <span class="wg_button_toggle" data-select="finished" data-sport="${t}">FINISHED</span>\n                <span class="wg_button_toggle" data-select="scheduled" data-sport="${t}">SCHEDULED</span>\n                <span class="wg-dropdown">\n                    <span class="wg-dropbtn" id="wg-${t}-dropbtn">${E}</span>\n                    <div class="wg-dropdown-content">\n                        <a href="#" data-date="${h}" class="wg-date" data-sport="${t}">${h}</a>\n                        <a href="#" data-date="${f}" class="wg-date" data-sport="${t}">${f}</a>\n                        <a href="#" data-date="${_}" class="wg-date" data-sport="${t}">${_}</a>\n                        <a href="#" data-date="${A}" class="wg-date" data-sport="${t}">${A}</a>\n                        <a href="#" data-date="${v}" class="wg-date" data-sport="${t}">${v}</a>\n                        <a href="#" data-date="${y}" class="wg-date" data-sport="${t}">${y}</a>\n                        <a href="#" data-date="${I}" class="wg-date" data-sport="${t}">${I}</a>\n                        <a href="#" data-date="${E}" class="wg-date wg-dropdown-color-select" data-sport="${t}">TODAY</a>\n                        <a href="#" data-date="${L}" class="wg-date" data-sport="${t}">${L}</a>\n                        <a href="#" data-date="${k}" class="wg-date" data-sport="${t}">${k}</a>\n                        <a href="#" data-date="${B}" class="wg-date" data-sport="${t}">${B}</a>\n                        <a href="#" data-date="${S}" class="wg-date" data-sport="${t}">${S}</a>\n                        <a href="#" data-date="${N}" class="wg-date" data-sport="${t}">${N}</a>\n                        <a href="#" data-date="${D}" class="wg-date" data-sport="${t}">${D}</a>\n                        <a href="#" data-date="${T}" class="wg-date" data-sport="${t}">${T}</a>\n                    </div>\n                </span>\n            </div>\n            <div id="wg-${t}-data" class="wg_loader"></div>\n        `;
        "false" === o && (H = `\n                <div id="wg-${t}-data" class="wg_loader"></div>\n            `), a.innerHTML = H, handball_games(l, r, g, e, s, i, b, c, u), $ >= 15 && Number.isInteger($) && (n = setInterval(function() {
    ...
    if (document.getElementById("wg-api-hockey-games")) {
        ...
        let h = m(7, "-"),
            ...
            T = m(7, "+"),
            H = `\n            <div id="wg-${t}-toolbar" class="wg_toolbar">\n                <span class="wg_button_toggle wg_active" data-select="all" data-sport="${t}">ALL</span>\n                <span class="wg_button_toggle" data-select="live" data-sport="${t}">LIVE</span>\n                <span class="wg_button_toggle" data-select="finished" data-sport="${t}">FINISHED</span>\n                <span class="wg_button_toggle" data-select="scheduled" data-sport="${t}">SCHEDULED</span>\n                <span class="wg-dropdown">\n                    <span class="wg-dropbtn" id="wg-${t}-dropbtn">${E}</span>\n                    <div class="wg-dropdown-content">\n                        <a href="#" data-date="${h}" class="wg-date" data-sport="${t}">${h}</a>\n                        <a href="#" data-date="${f}" class="wg-date" data-sport="${t}">${f}</a>\n                        <a href="#" data-date="${_}" class="wg-date" data-sport="${t}">${_}</a>\n                        <a href="#" data-date="${A}" class="wg-date" data-sport="${t}">${A}</a>\n                        <a href="#" data-date="${v}" class="wg-date" data-sport="${t}">${v}</a>\n                        <a href="#" data-date="${y}" class="wg-date" data-sport="${t}">${y}</a>\n                        <a href="#" data-date="${I}" class="wg-date" data-sport="${t}">${I}</a>\n                        <a href="#" data-date="${E}" class="wg-date wg-dropdown-color-select" data-sport="${t}">TODAY</a>\n                        <a href="#" data-date="${L}" class="wg-date" data-sport="${t}">${L}</a>\n                        <a href="#" data-date="${k}" class="wg-date" data-sport="${t}">${k}</a>\n                        <a href="#" data-date="${B}" class="wg-date" data-sport="${t}">${B}</a>\n                        <a href="#" data-date="${S}" class="wg-date" data-sport="${t}">${S}</a>\n                        <a href="#" data-date="${N}" class="wg-date" data-sport="${t}">${N}</a>\n                        <a href="#" data-date="${D}" class="wg-date" data-sport="${t}">${D}</a>\n                        <a href="#" data-date="${T}" class="wg-date" data-sport="${t}">${T}</a>\n                    </div>\n                </span>\n            </div>\n            <div id="wg-${t}-data" class="wg_loader"></div>\n        `;
        "false" === g && (H = `\n                <div id="wg-${t}-data" class="wg_loader"></div>\n            `), a.innerHTML = H, hockey_games(l, r, n, e, s, i, b, c, u), $ >= 15 && Number.isInteger($) && (o = setInterval(function() {
    ...
    if (document.getElementById("wg-api-rugby-games")) {
        ...
        let h = m(7, "-"),
            ...
            T = m(7, "+"),
            H = `\n            <div id="wg-${t}-toolbar" class="wg_toolbar">\n                <span class="wg_button_toggle wg_active" data-select="all" data-sport="${t}">ALL</span>\n                <span class="wg_button_toggle" data-select="live" data-sport="${t}">LIVE</span>\n                <span class="wg_button_toggle" data-select="finished" data-sport="${t}">FINISHED</span>\n                <span class="wg_button_toggle" data-select="scheduled" data-sport="${t}">SCHEDULED</span>\n                <span class="wg-dropdown">\n                    <span class="wg-dropbtn" id="wg-${t}-dropbtn">${E}</span>\n                    <div class="wg-dropdown-content">\n                        <a href="#" data-date="${h}" class="wg-date" data-sport="${t}">${h}</a>\n                        <a href="#" data-date="${f}" class="wg-date" data-sport="${t}">${f}</a>\n                        <a href="#" data-date="${_}" class="wg-date" data-sport="${t}">${_}</a>\n                        <a href="#" data-date="${A}" class="wg-date" data-sport="${t}">${A}</a>\n                        <a href="#" data-date="${v}" class="wg-date" data-sport="${t}">${v}</a>\n                        <a href="#" data-date="${y}" class="wg-date" data-sport="${t}">${y}</a>\n                        <a href="#" data-date="${I}" class="wg-date" data-sport="${t}">${I}</a>\n                        <a href="#" data-date="${E}" class="wg-date wg-dropdown-color-select" data-sport="${t}">TODAY</a>\n                        <a href="#" data-date="${L}" class="wg-date" data-sport="${t}">${L}</a>\n                        <a href="#" data-date="${k}" class="wg-date" data-sport="${t}">${k}</a>\n                        <a href="#" data-date="${B}" class="wg-date" data-sport="${t}">${B}</a>\n                        <a href="#" data-date="${S}" class="wg-date" data-sport="${t}">${S}</a>\n                        <a href="#" data-date="${N}" class="wg-date" data-sport="${t}">${N}</a>\n                        <a href="#" data-date="${D}" class="wg-date" data-sport="${t}">${D}</a>\n                        <a href="#" data-date="${T}" class="wg-date" data-sport="${t}">${T}</a>\n                    </div>\n                </span>\n            </div>\n            <div id="wg-${t}-data" class="wg_loader"></div>\n        `;
        "false" === g && (H = `\n                <div id="wg-${t}-data" class="wg_loader"></div>\n            `), a.innerHTML = H, rugby_games(l, r, n, e, s, o, i, c, u), $ >= 15 && Number.isInteger($) && (b = setInterval(function() {
    ...
    if (document.getElementById("wg-api-volleyball-games")) {
        ...
        let h = m(7, "-"),
            ...
            T = m(7, "+"),
            H = `\n            <div id="wg-${t}-toolbar" class="wg_toolbar">\n                <span class="wg_button_toggle wg_active" data-select="all" data-sport="${t}">ALL</span>\n                <span class="wg_button_toggle" data-select="live" data-sport="${t}">LIVE</span>\n                <span class="wg_button_toggle" data-select="finished" data-sport="${t}">FINISHED</span>\n                <span class="wg_button_toggle" data-select="scheduled" data-sport="${t}">SCHEDULED</span>\n                <span class="wg-dropdown">\n                    <span class="wg-dropbtn" id="wg-${t}-dropbtn">${E}</span>\n                    <div class="wg-dropdown-content">\n                        <a href="#" data-date="${h}" class="wg-date" data-sport="${t}">${h}</a>\n                        <a href="#" data-date="${f}" class="wg-date" data-sport="${t}">${f}</a>\n                        <a href="#" data-date="${_}" class="wg-date" data-sport="${t}">${_}</a>\n                        <a href="#" data-date="${A}" class="wg-date" data-sport="${t}">${A}</a>\n                        <a href="#" data-date="${v}" class="wg-date" data-sport="${t}">${v}</a>\n                        <a href="#" data-date="${y}" class="wg-date" data-sport="${t}">${y}</a>\n                        <a href="#" data-date="${I}" class="wg-date" data-sport="${t}">${I}</a>\n                        <a href="#" data-date="${E}" class="wg-date wg-dropdown-color-select" data-sport="${t}">TODAY</a>\n                        <a href="#" data-date="${L}" class="wg-date" data-sport="${t}">${L}</a>\n                        <a href="#" data-date="${k}" class="wg-date" data-sport="${t}">${k}</a>\n                        <a href="#" data-date="${B}" class="wg-date" data-sport="${t}">${B}</a>\n                        <a href="#" data-date="${S}" class="wg-date" data-sport="${t}">${S}</a>\n                        <a href="#" data-date="${N}" class="wg-date" data-sport="${t}">${N}</a>\n                        <a href="#" data-date="${D}" class="wg-date" data-sport="${t}">${D}</a>\n                        <a href="#" data-date="${T}" class="wg-date" data-sport="${t}">${T}</a>\n                    </div>\n                </span>\n            </div>\n            <div id="wg-${t}-data" class="wg_loader"></div>\n        `;
        "false" === g && (H = `\n                <div id="wg-${t}-data" class="wg_loader"></div>\n            `), a.innerHTML = H, volleyball_games(l, r, n, e, s, o, i, b, c), $ >= 15 && Number.isInteger($) && (u = setInterval(function() {
    ...
    function w(t) {
        ...
        if ("false" !== t && !s) {
            ...
            t.type = "text/css", t.rel = "stylesheet", t.href = a, document.getElementsByTagName("head")[0].appendChild(t)
        }
        if (("grey" === t || "dark" === t) && !d) {
            let t = document.createElement("link");
    ...
    document.addEventListener("click", function(t) {
        ...
        "football" === e && clearInterval(a), "baseball" === e && clearInterval(s), "basketball" === e && clearInterval(l), "handball" === e && clearInterval(n), "hockey" === e && clearInterval(o), "rugby" === e && clearInterval(b), "volleyball" === e && clearInterval(u), document.getElementById("wg-" + e + "-dropbtn").innerHTML = t.target.getAttribute("data-date");
        ...
        for (var g = 0; g < r.length; g++) {
            let a = r[g];
            a.getAttribute("data-sport") === e && (a.classList.contains("wg-dropdown-color-select") && a.classList.remove("wg-dropdown-color-select"), a.getAttribute("data-date") === t.target.getAttribute("data-date") && a.classList.add("wg-dropdown-color-select"))
        }
        let i = document.getElementsByClassName("wg_button_toggle");
        for (g = 0; g < i.length; g++) {
            let t = i[g];
            t.getAttribute("data-sport") === e && (t.classList.remove("wg_active"), "all" === t.getAttribute("data-select") && t.classList.add("wg_active"))
        }
        ...
        document.getElementById("wg-" + e + "-data").innerHTML = "", document.getElementById("wg-" + e + "-data").classList.add("wg_loader"), "football" === e && (football_games(m, $, h, c, w, f, _, A, v), y >= 15 && Number.isInteger(y) && (a = setInterval(function() {
            football_games(m, $, h, c, w, f, _, A, v), p(e)
        }, y))), "baseball" === e && (baseball_games(m, $, h, c, w, f, _, A, v), y >= 15 && Number.isInteger(y) && (s = setInterval(function() {
            baseball_games(m, $, h, c, w, f, _, A, v), p(e)
        }, y))), "basketball" === e && (basketball_games(m, $, h, c, w, f, _, A, v), y >= 15 && Number.isInteger(y) && (l = setInterval(function() {
            basketball_games(m, $, h, c, w, f, _, A, v), p(e)
        }, y))), "handball" === e && (handball_games(m, $, h, c, w, f, _, A, v), y >= 15 && Number.isInteger(y) && (n = setInterval(function() {
            handball_games(m, $, h, c, w, f, _, A, v), p(e)
        }, y))), "hockey" === e && (hockey_games(m, $, h, c, w, f, _, A, v), y >= 15 && Number.isInteger(y) && (o = setInterval(function() {
            hockey_games(m, $, h, c, w, f, _, A, v), p(e)
        }, y))), "rugby" === e && (rugby_games(m, $, h, c, w, f, _, A, v), y >= 15 && Number.isInteger(y) && (b = setInterval(function() {
            rugby_games(m, $, h, c, w, f, _, A, v), p(e)
        }, y))), "volleyball" === e && (volleyball_games(m, $, h, c, w, f, _, A, v), y >= 15 && Number.isInteger(y) && (u = setInterval(function() {
        ...
        document.getElementById("wb-" + a + "-modal") && document.getElementById("wb-" + a + "-modal").remove();
        let o = document.createElement("div");
        o.id = "wb-" + a + "-modal", o.classList.add("wg_modal");
        let i = document.createElement("div");
        i.classList.add("wg_modal_content"), o.appendChild(i);
        let b = document.createElement("span");
        b.classList.add("wg_modal_close"), b.setAttribute("data-sport", a), b.setAttribute("data-modal", "standings"), b.innerHTML = "&times;", i.appendChild(b);
        let c = document.createElement("div");
        if (c.id = "wb-" + a + "-modal-data", c.classList.add("wg_loader"), i.appendChild(c), e.appendChild(o), o.style.display = "block", "football" === a) {
            let a = t.target.getAttribute("data-team");
            football_standings(s, d, a, l, r, n, g, !0)
        }
        "baseball" === a && baseball_standings(s, d, l, r, n, g, !0), "basketball" === a && basketball_standings(s, d, l, r, n, g, !0), "handball" === a && handball_standings(s, d, l, r, n, g, !0), "hockey" === a && hockey_standings(s, d, l, r, n, g, !0), "rugby" === a && rugby_standings(s, d, l, r, n, g, !0), "volleyball" === a && volleyball_standings(s, d, l, r, n, g, !0)
        ...
        document.getElementById("wb-" + s + "-modal") && document.getElementById("wb-" + s + "-modal").remove();
        let p = document.createElement("div");
        p.id = "wb-" + s + "-modal", p.classList.add("wg_modal");
        let $ = document.createElement("div");
        $.classList.add("wg_modal_content"), p.appendChild($);
        let h = document.createElement("span");
        h.classList.add("wg_modal_close"), h.setAttribute("data-sport", s), h.setAttribute("data-modal", "game"), h.innerHTML = "&times;", $.appendChild(h);
        let f = document.createElement("div");
        f.id = "wb-" + s + "-modal-data", f.classList.add("wg_loader"), $.appendChild(f), l.appendChild(p), p.style.display = "block", "football" === s && (clearInterval(t), football_game(n, o, b, u, w, !0), m >= 15 && Number.isInteger(m) && (t = setInterval(function() {
            football_game(n, o, b, u, w, !0)
        }, m))), "baseball" === s && (clearInterval(e), baseball_game(n, o, b, u, w, !0), m >= 15 && Number.isInteger(m) && (e = setInterval(function() {
            baseball_game(n, o, b, u, w, !0)
        }, m))), "basketball" === s && (clearInterval(d), basketball_game(n, o, b, u, w, !0), m >= 15 && Number.isInteger(m) && (d = setInterval(function() {
            basketball_game(n, o, b, u, w, !0)
        }, m))), "handball" === s && (clearInterval(r), handball_game(n, o, b, u, w, !0), m >= 15 && Number.isInteger(m) && (r = setInterval(function() {
            handball_game(n, o, b, u, w, !0)
        }, m))), "hockey" === s && (clearInterval(g), hockey_game(n, o, b, u, w, !0), m >= 15 && Number.isInteger(m) && (g = setInterval(function() {
            hockey_game(n, o, b, u, w, !0)
        }, m))), "rugby" === s && (clearInterval(i), rugby_game(n, o, b, u, w, !0), m >= 15 && Number.isInteger(m) && (i = setInterval(function() {
            rugby_game(n, o, b, u, w, !0)
        }, m))), "volleyball" === s && (clearInterval(c), volleyball_game(n, o, b, u, w, !0), m >= 15 && Number.isInteger(m) && (c = setInterval(function() {
        ...
        for (r = 0; r < n.length; r++) {
            let t = n[r];
            t.getAttribute("data-id") === s && (t.classList.contains("wg_hide") || t.classList.add("wg_hide"))
        }
        document.getElementById(a + "-game-" + d + "-" + e + "-" + s).classList.remove("wg_hide")
    }, !1), document.addEventListener("click", function(t) {
        ...
        for (var d = 0; d < s.length; d++) {
            let t = s[d];
            t.classList.contains("wg_hide") ? (t.classList.remove("wg_hide"), a.classList.remove("wg_arrow_down"), a.classList.add("wg_arrow_up")) : (t.classList.add("wg_hide"), a.classList.remove("wg_arrow_up"), a.classList.add("wg_arrow_down"))
        }
    }, !1)
});