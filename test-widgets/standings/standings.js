export async function football_standings(t, e, a, l, s, n, o, _ = !1) {
    ...
    let w = "?";
    null !== t && "" !== t && ("?" !== w && (w += "&"), w += "league=" + t), null !== a && "" !== a && ("?" !== w && (w += "&"), w += "team=" + a), null !== e && "" !== e && ("?" !== w && (w += "&"), w += "season=" + e);
    try {
        //const t = await fetch(g + "standings" + w, r);
        //http://127.0.0.1/widgets/v3_standings_140_2022.json
        let myurl = "http://127.0.0.1/api-v3/test-widgets/standings/v3_standings_140_2022.json";
        const t = await fetch(myurl, r);
