import {
    football_games
} from "http://127.0.0.1/api-v3/test-widgets/games/games.js";
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    function w(t) {
        let a = "http://127.0.0.1/api-v3/test-widgets/games/widgets.css",
            e = "http://127.0.0.1/api-v3/test-widgets/games/widgets-" + t + ".css",
            s = !1,
            d = !1,
    ...
    document.addEventListener("click", function(t) {
        ...
        let d = t.target.getAttribute("data-select"),
            l = [];
        "football" === a && ("live" === d && (l = ["1H", "2H", "ET", "P", "LIVE", "HT", "BT"]), "finished" === d && (l = ["FT", "AET", "PEN"]), "scheduled" === d && (l = ["NS"]));
        let r = {},
            n = {},
