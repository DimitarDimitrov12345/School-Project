export async function football_game(t, e, s, a, l, n = !1) {
    ...
    try {
		...
		let apiurl = "http://127.0.0.1/api-v3/test-widgets/game/v3_fixtures_718243.json";
		const t = await fetch(apiurl, i);
		document.getElementById("myP").innerHTML = o + "fixtures" + d + Date();
